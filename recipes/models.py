...
#     Recipe.objects.create(Title='recipe8',Description='desc2',PrepSteps=[],Difficulty='HARD',Gallery=[],Category='cat2',Language=[],Owner=user,CookingTime='3 hours',PrepTime='4',SeasonalTags=[],Keywords=[],PopularityScore=4)